...
- 63f2eae: Add branded types — a new `brand` slice for turning loose primitives into distinct nominal types.
...
- 52cc1ab: Drop redundant type assertions flagged by oxlint 1.73.
